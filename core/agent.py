...
class MorphikAgent:
    ...
    def __init__(
        ...
        content_guidelines = "for text objects, this is markdown content; for image objects, this is a description for the "
        content_guidelines += "image, describing the exact part you want to extract from the source chunk. This description will be "
